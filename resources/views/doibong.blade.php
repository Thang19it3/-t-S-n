...
<head>
	...
	<link rel="stylesheet" href="css/doibong.css">
...
<header>
	...
	<div class="doibong">
		<img src="img/sport-bg-1.jpg">
		<img src="img/player-euro.png" id="euro">
		<img src="img/player-asia.png" id="asia">
		<div class="doibong-text-1">
			<h5>TẠO ĐỘI BÓNG CHO RIÊNG MÌNH</h5>
			<a href="http://127.0.0.1:8000/trangchu/doibong1/dang-ky" class="btn">Tạo Ngay</a>
		</div>
		<div class="doibong-text-2">
			<h5>TÌM ĐỘI BÓNG PHÙ HỢP MÌNH</h5>
			<a href="http://127.0.0.1:8000/tim-doibong" class="btn">Tìm Ngay</a>
		</div>
	</div>
	<footer>
		<div class="container">
