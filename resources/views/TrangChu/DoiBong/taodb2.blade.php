...
<body>
	<header>
		...
		<nav>
			<ul>
				...
				<li>
					<a href="doibong.html" class="active">Đội Bóng</a>
				</li>
				<li>
	...
	<div class="container">
		<div style="text-align: center;margin-top: 50px;">
			<h1>B3: THÀNH CÔNG</h1>
			<button class="btn btn-danger">TRANH CHỦ</button> <br><button class="btn btn-danger">TÌM ĐỐI THỬ</button> <br>
			<a href="http://127.0.0.1:8000/trangchu/doibong1/profile" class="btn btn-danger">Đội Bóng</a>
		</div>
	</div>
	<footer>
		<div class="container">
